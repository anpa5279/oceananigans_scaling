...
setup_start = time()
const Nx = 544        # number of points in each of x direction
const Ny = 544        # number of points in each of y direction
const Nz = 544        # number of points in the vertical direction
