...
setup_start = time()
const Nx = 1152        # number of points in each of x direction
const Ny = 1152        # number of points in each of y direction
const Nz = 576        # number of points in the vertical direction
