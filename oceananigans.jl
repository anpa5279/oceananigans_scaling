...
setup_start = time()
const Nx = 320        # number of points in each of x direction
const Ny = 320        # number of points in each of y direction
const Nz = 320        # number of points in the vertical direction
