...
setup_start = time()
const Nx = 400        # number of points in each of x direction
const Ny = 400        # number of points in each of y direction
const Nz = 400        # number of points in the vertical direction
