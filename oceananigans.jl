...
setup_start = time()
const Nx = 800        # number of points in each of x direction
const Ny = 800        # number of points in each of y direction
const Nz = 800        # number of points in the vertical direction
