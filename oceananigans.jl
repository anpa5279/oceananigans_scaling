...
setup_start = time()
const Nx = 600        # number of points in each of x direction
const Ny = 600        # number of points in each of y direction
const Nz = 600        # number of points in the vertical direction
