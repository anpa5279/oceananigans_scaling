...
setup_start = time()
const Nx = 640        # number of points in each of x direction
const Ny = 640        # number of points in each of y direction
const Nz = 640        # number of points in the vertical direction
