...
setup_start = time()
const Nx = 300        # number of points in each of x direction
const Ny = 300        # number of points in each of y direction
const Nz = 300        # number of points in the vertical direction
