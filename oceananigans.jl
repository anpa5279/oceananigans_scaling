...
setup_start = time()
const Nx = 648        # number of points in each of x direction
const Ny = 648        # number of points in each of y direction
const Nz = 648        # number of points in the vertical direction
