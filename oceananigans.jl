...
setup_start = time()
const Nx = 288        # number of points in each of x direction
const Ny = 288        # number of points in each of y direction
const Nz = 288        # number of points in the vertical direction
