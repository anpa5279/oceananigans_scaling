...
setup_start = time()
const Nx = 768        # number of points in each of x direction
const Ny = 768        # number of points in each of y direction
const Nz = 768        # number of points in the vertical direction
