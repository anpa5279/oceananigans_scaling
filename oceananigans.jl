...
setup_start = time()
const Nx = 464        # number of points in each of x direction
const Ny = 464        # number of points in each of y direction
const Nz = 464        # number of points in the vertical direction
