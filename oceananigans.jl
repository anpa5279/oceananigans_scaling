...
setup_start = time()
const Nx = 864        # number of points in each of x direction
const Ny = 864        # number of points in each of y direction
const Nz = 864        # number of points in the vertical direction
