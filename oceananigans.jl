...
setup_start = time()
const Nx = 432        # number of points in each of x direction
const Ny = 432        # number of points in each of y direction
const Nz = 432        # number of points in the vertical direction
